...
def GetInitializationTimestamp() -> int: ...
def GetLastCheckpointTimestamp() -> int: ...
...
def SetInitializationTimestamp(timestamp_ns: int) -> None: ...
def SetLastCheckpointTimestamp(timestamp_ns: int) -> None: ...
