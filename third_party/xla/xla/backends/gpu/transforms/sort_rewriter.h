...
#ifndef XLA_BACKENDS_GPU_TRANSFORMS_SORT_REWRITER_H_
#define XLA_BACKENDS_GPU_TRANSFORMS_SORT_REWRITER_H_
...
class SortRewriter : public HloModulePass {
 public:
  explicit SortRewriter(const se::DeviceDescription& device_description,
      ...
      : device_description_(device_description),
        ...
        early_exit_with_layouts_(early_exit_with_layouts) {}
 ...
 private:
  ...
  bool is_deviceless_;
  bool early_exit_with_layouts_;
};

}  // namespace gpu
}  // namespace xla

#endif  // XLA_BACKENDS_GPU_TRANSFORMS_SORT_REWRITER_H_
