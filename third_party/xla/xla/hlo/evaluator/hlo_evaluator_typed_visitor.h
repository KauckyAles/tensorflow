 ...
 public:
  ...
  absl::Status HandleConvolution(const HloInstruction* conv) override {
    ...
    if (conv->sparsity_config().has_lhs()) {
      ...
      TF_ASSIGN_OR_RETURN(decompressed_lhs, xla::MaterializeSparseOperand(
                                                LiteralSlice(tuple_lit, {0}),
                                                LiteralSlice(tuple_lit, {1}),
    ...
    if (conv->sparsity_config().has_rhs()) {
      ...
      TF_ASSIGN_OR_RETURN(decompressed_rhs, xla::MaterializeSparseOperand(
                                                LiteralSlice(tuple_lit, {0}),
                                                LiteralSlice(tuple_lit, {1}),
