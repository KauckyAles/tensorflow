...
// LinearizedInterpreter::Ops provides static execution methods for each HLO
// opcode supported by the LinearizedInterpreter. These methods operate on
// flat buffers in the Scratchpad.
...
template <typename ResT, typename LhsT, typename RhsT>
void LinearizedInterpreter::Ops::ExecuteAdd(const Step* step,
...
template <typename T>
void LinearizedInterpreter::Ops::ExecuteMaximum(const Step* step,
                                                void* scratchpad_base) {
...
template <typename T, ComparisonDirection Direction>
void LinearizedInterpreter::Ops::ExecuteCompare(const Step* step,
                                                void* scratchpad_base) {
...
inline void LinearizedInterpreter::Ops::ExecuteOr(const Step* step,
                                                  void* scratchpad_base) {
  bool* result = reinterpret_cast<bool*>(static_cast<char*>(scratchpad_base) +
                                         step->result_offset);
...
inline void LinearizedInterpreter::Ops::ExecuteAnd(const Step* step,
                                                   void* scratchpad_base) {
  bool* result = reinterpret_cast<bool*>(static_cast<char*>(scratchpad_base) +
                                         step->result_offset);
  const bool* lhs = reinterpret_cast<const bool*>(
...
template <typename T>
void LinearizedInterpreter::Ops::ExecuteSelect(const Step* step,
                                               void* scratchpad_base) {
  T* result = reinterpret_cast<T*>(static_cast<char*>(scratchpad_base) +
                                   step->result_offset);
...
inline void LinearizedInterpreter::Ops::ExecuteSlice(const Step* step,
                                                     void* scratchpad_base) {
...
inline void LinearizedInterpreter::Ops::ExecuteBroadcast(
    const Step* step, void* scratchpad_base) {
...
template <typename T>
void LinearizedInterpreter::Ops::ExecuteIota(const Step* step,
                                             void* scratchpad_base) {
...
template <typename T>
void LinearizedInterpreter::Ops::ExecuteLookup(const Step* step,
                                               void* scratchpad_base) {
...
template <typename T>
absl::Status LinearizedInterpreter::Ops::SetCompareExecuteFn(
    Step& step, ComparisonDirection direction) {
  switch (direction) {
